...
def get_args_parser():
    ...
    # Seed
    parser.add_argument('--main_seed', default=1, type=int, help="main seed")


    # Evaluation settings
    parser.add_argument('--print_detail_crop', default=0, type=int, help="whether to print the cropped uvd error in each direction")
    parser.add_argument('--print_detail_uvd', default=0, type=int, help="whether to print the original uvd error in each direction")
    parser.add_argument('--print_detail_xyz', default=0, type=int, help="whether to print the original xyz error in each direction")
    ...
    # Controls the degree of random jitter applied to the center-of-mass joint
    ...
    parser.add_argument('--RandDotPercentage',default=0.15, type=float,help="an augmentation where it randomly zeros out a percentage of foreground pixels")
    ...
    # Whether to use depth scaling augmentation
    ...
    # Path of the .pth file used to resume training from a checkpoint
    parser.add_argument('--model_path',type=str, help="the address where the model is saved for resuming the training")

    parser.add_argument('--checkpoints_dir',type=str,default='nyu_experiment', help="where to save model chekpoints")
    
    parser.add_argument('--LossFunction',type=str,default="L1", choices=('L2', 'L1','huber'), help="The choice of the loss function")

    # Training mode. When 'aleatoric' is chosen, the L2 loss function should be used
    ...
    # Whether to use weight decay (L2 regularization)
    parser.add_argument('--decay_bias',default=1, type=int, help="whether to use decay on bias weights")

    parser.add_argument('--config_file',default="configs/icvl.yaml",type=str,help="whether or not to load .yaml config file to overwrite some args arguments")
    ...
    #### Scheduler
    # Choose different learning rate schedulers
    ...
    # Whether to learn the "smoothness"/"temperature" of the spatial softmax, i.e. the channel-wise scaling factor applied before softmax
